...
However, in the R environment these are vestigal items. A better way of determining volume is to calculate the volume and dominant height for any particular data point. The standview package allows for this with the dmd.volume function: `dmd.volume(ineq=i,...)`.
